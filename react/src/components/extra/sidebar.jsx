    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          viewBox="0 0 640 512"
          className="mr-2 h-4 w-4"
          fill={currentRoute.includes("teams") ? "white" : "currentColor"}
        >
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          className="mr-2 h-4 w-4"
          fill={
            currentRoute.includes("user-approval") ? "white" : "currentColor"
          }
        >
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          viewBox="0 0 384 512"
          className="mr-2 h-4 w-4"
          fill={currentRoute.includes("reports") ? "white" : "currentColor"}
        >
