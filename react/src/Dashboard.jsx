import { DashboardContextProvider, useDashboardContext } from './context/DashboardContextProvider';
    ...
    <DashboardContextProvider>
      <div className='h-full px-4 py-6 lg:px-8'>
        <Tabs defaultValue='team_productivity' className='h-full space-y-6'>
          ...
          {/* Team Productivity */}
          <TabsContent value='team_productivity' className='h-full flex-col border-none p-0'>
            <div className='flex items-center justify-between'>
              <div className='space-y-1'>
                <h2 className='text-2xl font-semibold tracking-tight'>Productivity Chart</h2>
              </div>
            </div>
            ...
            <div className='mt-6 space-y-1'>
              <h2 className='text-2xl font-semibold tracking-tight'>Application List</h2>
              <p className='text-sm text-muted-foreground'>Lists of all applications used by the team.</p>
            </div>
            <Separator className='my-4' />
            <div className='relative'>
              <ScrollArea>
                <div className='grid grid-cols-3 gap-4'>
                  <div className='col-span-1'>
                    <TeamAppList title={'Productive apps'} apps={appList.Productive} className={'bg-success text-success-foreground'} />
                  </div>
                  <div className='col-span-1'>
                    <TeamAppList title={'Unproductive apps'} apps={appList.Unproductive} className={'bg-warning text-warning-foreground'} />
                  </div>
                  <div className='col-span-1'>
                    <TeamAppList title={'Neutral apps'} apps={appList.Neutral} className={'bg-muted text-muted-foreground'} />
                  </div>
                </div>
                <ScrollBar orientation='horizontal' />
              </ScrollArea>
          ...
          {/* Late */}
          <TabsContent value='present' className='h-full flex-col border-none p-0 data-[state=active]:flex'>
            <div className='flex items-center justify-between'>
              <div className='space-y-1'>
                <h2 className='text-2xl font-semibold tracking-tight'>Employee Tardiness</h2>
          ...
          {/* Absent */}
          <TabsContent value='absent' className='h-full flex-col border-none p-0 data-[state=active]:flex'>
            <div className='flex items-center justify-between'>
              <div className='space-y-1'>
          ...
          {/* Present */}
          <TabsContent value='late' className='h-full flex-col border-none p-0 data-[state=active]:flex'>
            <div className='flex items-center justify-between'>
              <div className='space-y-1'>
                <h2 className='text-2xl font-semibold tracking-tight'>New Episodes</h2>
                <p className='text-sm text-muted-foreground'>Your favorite podcasts. Updated daily.</p>
          ...
          {/* Late */}
          <TabsContent value='anomaly' className='h-full flex-col border-none p-0 data-[state=active]:flex'>
            <div className='flex items-center justify-between'>
              <div className='space-y-1'>
                <h2 className='text-2xl font-semibold tracking-tight'>Invalid time in/out</h2>
                {/* <p className="text-sm text-muted-foreground">
                          Your favorite podcasts. Updated daily.
                        </p> */}
              </div>
